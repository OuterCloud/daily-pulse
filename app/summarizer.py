...
1. 执行摘要（3-5 句总结今日技术动态）
2. 今日主题（识别 3-5 个跨来源共同趋势）
3. GitHub 热门亮点（Top 5 仓库，含通俗说明）
4. Hacker News 亮点（Top 5 故事，含说明）
5. 学术论文（Top 3-5 篇，用通俗语言解释研究内容）
6. Product Hunt 精选（Top 3-5 产品，含简介）
7. 今日技术焦点（最重要技术的深度分析，400-600 字）
8. 实践建议（3-5 条可操作建议）"""
...
**First**: Output the title line (must be the very first line of the report):
# DailyPulse · 每日脉搏 | YYYY-MM-DD

**Immediately after the title**: Output a "Market Briefing" block.
...
**Then**: Generate the following 8 sections:

1. Executive Summary (3-5 sentences summarizing today's tech highlights)
2. Today's Themes (3-5 cross-source common trends)
3. GitHub Trending Highlights (Top 5 repos with plain-language descriptions)
4. Hacker News Highlights (Top 5 stories with descriptions)
5. Academic Papers (Top 3-5 papers, explained in plain language)
6. Product Hunt Picks (Top 3-5 products with brief descriptions)
7. Tech Focus of the Day (in-depth analysis of the most important technology, 400-600 words)
8. Practical Takeaways (3-5 actionable recommendations)"""
